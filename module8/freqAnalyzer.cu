...
/// 
/// \returns total exection time (in ms) including data transfer
///////////////////////////////////////////////////////////////////////////////
float runFFT(const float* timeSignal, float* freqSignalMagnitudes, const unsigned int n, const unsigned int blockSize)
{
	// start clock
...
int main(int argc, char** argv)
{
	...
	float ms = runFFT(timeSignal, freqSignalMagnitudes, dataSize, blockSize);
